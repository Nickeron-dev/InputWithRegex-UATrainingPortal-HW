...
public interface RegexCotainer {
    ...
    // Regex
    /*
    public static final String LAST_NAME_REGEX = "[A-Z][a-z]{1,20}$";
    public static final String FIRST_NAME_REGEX = "[A-Z][a-z]{1,20}$";
    public static final String PATRONYMIC_REGEX = "[A-Z][a-z]{1,20}$";
    ...
    */
    public static final String NICKNAME_REGEX = "[A-Za-z0-9]{5,30}$";
